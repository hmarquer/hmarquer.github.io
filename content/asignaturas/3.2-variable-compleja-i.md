...
#REVISAR 
#COMPLETAR 
#DEMOSTRACIÓN no la hemos visto en clase
#EJERCICIO lo hizo en clase
#FALTA todo el día copiar de las fotos del día 24/03/2025
#EJERCICIO mirar fotos del día 24/04/2025
#ORDENAR referenciar al criterio en cuestión
#DEMOSTRACIÓN pedírsela a Raquel
#DEMOSTRACIÓN 
#REVISAR arreglar un poco
#REVISAR porque esto no es cierto en general
#ORDENAR a lo mejor dividir en varios teoremas porque vaya desorden
#ORDENAR referenciar
#REVISAR porque algo está mal
#REVISAR qué está pasando aquí
#EJERCICIO foto julia
#COMPLETAR con caso y < 0 y dibujo de la foto de la pizarra día 13/02/2025
#COMPLETAR sale g \in C (C \setminus |z| = 1 \cup z = 1)
#ORDENAR referenciar todo
#FIXME CANDIDATO A EXAMEN
#ORDENAR referenciar \\ mostraba que $\bar{z}$ no es continua en ningún punto de $\C$.
#DEMOSTRACIÓN completarla
#DEMOSTRACIÓN se supone que ya lo hemos visto.
#COMPLETAR estaría bien un dibujo
#COMPLETAR con dibujo de la foto
#COMPLETAR con dibujo análogo
#COMPLETAR falta un ejercicio, mirar la foto del día 26/03/2025
#COMPLETAR está en el cuadernillo
#FALTA pero no cae en el examen
